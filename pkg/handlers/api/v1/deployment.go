...
func (d *deployment) UpdateDeployment(ctx *gin.Context) {
	...
	err = type_deployment.Deployment.UpdateDeployment(client, params.Namespace, params.Content)
	if err != nil {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"message": err.Error(),
			"data":    nil,
...
func (d *deployment) RestartDeployment(ctx *gin.Context) {
	...
	err = type_deployment.Deployment.RestartDeployment(client, params.DeploymentName, params.Namespace)
	if err != nil {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"message": err.Error(),
			"data":    nil,
...
func (d *deployment) CreateDeployment(ctx *gin.Context) {
	...
	err = type_deployment.Deployment.CreateDeployment(client, deployCreate)
	if err != nil {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"message": err.Error(),
			"data":    nil,
...
func (d *deployment) DeleteDeployment(ctx *gin.Context) {
	...
	err = type_deployment.Deployment.DeleteDeployment(client, params.DeploymentName, params.Namespace)
	if err != nil {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"message": err.Error(),
			"data":    nil,
